...
<div class="container mt-5">
    <hr>
    <footer class="m-3 p-3 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            <!-- <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
                <img src="/sefast/imgs/sefst2.png" alt="" width="30%">
            </a> -->
            <span class="mb-3 mb-md-0 text-body-secondary">&copy; <?= date('Y') ?> SEFAST</span>
        </div>
